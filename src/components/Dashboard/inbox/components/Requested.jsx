...
const Requested = () => {
  ...
  const applyFilterAndSort = (data) => {
    ...
    if (selectedFilter === "onlineNow") {
      filtered = filtered.filter((item) => item.receiver_online_status === "online");
                        ...
                        <div className="col-md-7">
                          <div className="d-flex justify-content-between">
                            <div className="profile-part-inbox">
                              ...
                              {currentReceiver.receiver_online_status === "online" ? (
                                ...
                                <div className="text-muted mb-2" style={{ fontSize: "14px" }}>
                                  ...
                                  {formatLastSeen(currentReceiver.receiver_online_status)}
                                </div>
                              )}
                            </div>
