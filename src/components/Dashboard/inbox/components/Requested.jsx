...
const Requested = () => {
  ...
  useEffect(() => {
    const fetchAcceptedReceivers = async () => {
      try {
        const response = await fetch(`${config.baseURL}/api/inbox/sender/${user.id}`);
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-7">
                      <div className="d-flex justify-content-between">
                        <div className="profile-part-inbox">
                          <div className="profile-nameinbox">
                            {currentReceiver.receiver_first_name} {currentReceiver.receiver_last_name}
                          </div>
                      ...
                      <div className="profile-info">
                        ...
                        {currentReceiver.receiver_community}, {currentReceiver.receiver_religion} <br />
                        {currentReceiver.receiver_city}, {currentReceiver.receiver_living_in} <br />
